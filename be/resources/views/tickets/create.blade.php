            ...
            <form class="needs-validation" novalidate action="{{ route('ticket.store', $event) }}" method="post">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <select class="form-control" id="selectSpecialValidity" name="special_validity">
                            ...
                            <option value="date" {{ old('special_validity') == 'date'? 'selected' : '' }}>Có thể mua đến ngày</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('amount') is-invalid @enderror" id="inputAmount" name="amount" placeholder="" 
                        value="{{ old('amount') }}">
                        @error('amount')
                        <div class="invalid-feedback">
                            {{$message}}
