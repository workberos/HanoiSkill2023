...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form class="needs-validation" action="{{ route('session.store', $event) }}" method='post'>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('speaker') is-invalid @enderror" id="inputSpeaker" name="speaker" 
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        name="cost" placeholder="" value="{{ old('cost') }}">
                        @error('cost')
                        <div class="invalid-feedback">
                            Costkhông được để trống.
                        </div>
                        @enderror
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" id="textareaDescription" name="description" placeholder="" rows="5">{{ old('description') }}</textarea>
                    </div>
                </div>
